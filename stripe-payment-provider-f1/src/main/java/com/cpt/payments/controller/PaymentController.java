...
public class PaymentController {
	...
	public ResponseEntity<CreatePaymentRes> createTransaction(@RequestBody CreatePaymentReq paymentReq) {

		System.out.println("PaymentController.createTransaction() || " + "paymentReq : " + paymentReq);

		CreatePaymentReqDTO reqDTO = modelMapper.map(paymentReq, CreatePaymentReqDTO.class);

		System.out.println("Converted pojo to dto : " + reqDTO);
		...
		System.out.println("Converted response back to pojo : " + finalRes);
